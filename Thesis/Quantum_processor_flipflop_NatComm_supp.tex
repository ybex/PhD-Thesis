\documentclass[aps,prb,superscriptaddress,nobibnotes,twocolumn]{revtex4-1}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=\columnwidth]{table1_xy-gate-errors}
%		\caption{\textbf{Error table}. Estimated gate error rates from different noise sources, according to Supplementary Information \ref{App:Elec_noise}. Hyphens indicate inexistent/negligible errors.}
%	\label{fig:xy-gate-errors}
%\end{figure}

%{.796,.63,.153}
\begin{table}
	\begin{tabular}{p{1.15in}b{.7in}b{.65in}b{.7in}} %\cmidrule(r){1-2}%\hline
...
\bibitem{Note1}
\bibinfo{note}{{http://www.synopsys.com/TOOLS/TCAD/}}.
...
%``Silicon quantum processor with robust long-distance qubit couplings", by G. Tosi \emph{et.al.}\\
%\vspace{3mm}}
%\end{center}
%\twocolumngrid
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figsupp1-Nemo-levels}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figsupp2-image-charges}
...
\bibitem{Kohn1955S}
\bibinfo{author}{Kohn, W.} \& \bibinfo{author}{Luttinger, J.~M.}
\newblock \bibinfo{title}{Theory of donor states in silicon}.
\newblock \emph{\bibinfo{journal}{Phys. Rev.}} \textbf{\bibinfo{volume}{98}},
  \bibinfo{pages}{915--922} (\bibinfo{year}{1955}).

\bibitem{Saraiva2009S}
\bibinfo{author}{Saraiva, A.~L.}, \bibinfo{author}{Calder\'on, M.~J.},
  \bibinfo{author}{Hu, X.}, \bibinfo{author}{Das~Sarma, S.} \&
  \bibinfo{author}{Koiller, B.}
\newblock \bibinfo{title}{Physical mechanisms of interface-mediated intervalley
  coupling in Si}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. B}} \textbf{\bibinfo{volume}{80}},
  \bibinfo{pages}{081305} (\bibinfo{year}{2009}).

\bibitem{Rahman2009S}
\bibinfo{author}{Rahman, R.} \emph{et~al.}
\newblock \bibinfo{title}{Orbital stark effect and quantum confinement
  transition of donors in silicon}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. B}} \textbf{\bibinfo{volume}{80}},
  \bibinfo{pages}{165314} (\bibinfo{year}{2009}).

\bibitem{Calderon2009S}
\bibinfo{author}{Calder\'on, M.~J.}, \bibinfo{author}{Saraiva, A.},
  \bibinfo{author}{Koiller, B.} \& \bibinfo{author}{Das~Sarma, S.}
\newblock \bibinfo{title}{Quantum control and manipulation of donor electrons
  in Si-based quantum computing}.
\newblock \emph{\bibinfo{journal}{J. Appl. Phys.}}
  \textbf{\bibinfo{volume}{105}}, \bibinfo{pages}{122410} (\bibinfo{year}{2009}).
\newblock

\bibitem{Klimeck2007S}
\bibinfo{author}{Klimeck, G.} \emph{et~al.}
\newblock \bibinfo{title}{Atomistic simulation of realistically sized
  nanodevices using {NEMO 3-D} -- part I: Models and benchmarks}.
\newblock \emph{\bibinfo{journal}{Electron Devices, IEEE Transactions on}}
  \textbf{\bibinfo{volume}{54}}, \bibinfo{pages}{2079--2089}
  (\bibinfo{year}{2007}).

\bibitem{Klimeck2007aS}
\bibinfo{author}{Klimeck, G.} \emph{et~al.}
\newblock \bibinfo{title}{Atomistic simulation of realistically sized
  nanodevices using {NEMO 3-D} -- part II: Applications}.
\newblock \emph{\bibinfo{journal}{Electron Devices, IEEE Transactions on}}
  \textbf{\bibinfo{volume}{54}}, \bibinfo{pages}{2090--2099}
  (\bibinfo{year}{2007}).

\bibitem{Yang2013S}
\bibinfo{author}{Yang, C.~H.}, \bibinfo{author}{Rossi, A.},
  \bibinfo{author}{Ruskov, R.}, \bibinfo{author}{Lai, N.~S.},
  \bibinfo{author}{Mohiyaddin, F.~A.}, \bibinfo{author}{Lee, S.},
  \bibinfo{author}{Tahan, C.}, \bibinfo{author}{Klimeck, G.},
  \bibinfo{author}{Morello, A.} \& \bibinfo{author}{Dzurak, A.~S.}
\newblock \bibinfo{title}{Spin-valley lifetimes in a silicon quantum dot with
...
\bibinfo{author}{Ravets, S.}, \bibinfo{author}{Labuhn, H.},
  \bibinfo{author}{Barredo, D.}, \bibinfo{author}{Beguin, L.},
  \bibinfo{author}{Lahaye, T.} \& \bibinfo{author}{Browaeys, A.}
\newblock \bibinfo{title}{Coherent dipole-dipole coupling between two single Rydberg atoms at an electrically-tuned R\"orster resonance}.
\newblock \emph{\bibinfo{journal}{Nature Phys.}} \textbf{\bibinfo{volume}{10}},
  \bibinfo{pages}{914--917} (\bibinfo{year}{2014}).
 
\bibitem{Johnson2010S}
\bibinfo{author}{Johnson, B.~C.}, \bibinfo{author}{McCallum, J.~C.},
  \bibinfo{author}{Willems van Beveren, L.~H.}, \bibinfo{author}{Beguin, L.} \& \bibinfo{author}{Gauja, E.}
\newblock \bibinfo{title}{Deep level transient spectroscopy study for the development of ion-implanted silicon field-effect transistors for spin-dependent transport}.
\newblock \emph{\bibinfo{journal}{Thin Solid Films}} \textbf{\bibinfo{volume}{518}},
  \bibinfo{pages}{2524} (\bibinfo{year}{2010}).
 
\bibitem{Paladino2014S}
\bibinfo{author}{Paladino, E.}, \bibinfo{author}{Galperin, Y.~M.},
  \bibinfo{author}{Falci, G.} \& \bibinfo{author}{Altshuler, B.~L.}
\newblock \bibinfo{title}{$1/f$ noise: Implications for solid-state quantum information}.
\newblock \emph{\bibinfo{journal}{Rev. Mod. Phys.}} \textbf{\bibinfo{volume}{86}},
  \bibinfo{pages}{361--418} (\bibinfo{year}{2014}).

\bibitem{Kim2015S}
\bibinfo{author}{Kim, D.} \emph{et~al.}
\newblock \bibinfo{title}{High-fidelity resonant gating of a silicon-based quantum dot hybrid qubit}.
\newblock \emph{\bibinfo{journal}{npj Quantum Information}}
\textbf{\bibinfo{volume}{1}}, \bibinfo{pages}{15004}
(\bibinfo{year}{2015}).

\bibitem{Thorgrimsson2016S}
\bibinfo{author}{Thorgrimsson, B.} \emph{et~al.}
\newblock \bibinfo{title}{Extending the coherence of a quantum dot hybrid qubit}.
\newblock \bibinfo{journal}{Preprint at}
  \url{http://arxiv.org/abs/1611.04945}
  (\bibinfo{year}{2016}).
  
\bibitem{Freeman2016S}
\bibinfo{author}{Freeman, B.~M.}, \bibinfo{author}{Schoenfield, J.~S.},
  \bibinfo{author}{Jiang, H.}
\newblock \bibinfo{title}{{Comparison of low frequency charge noise in identically patterned Si/SiO$_2$ and Si/SiGe quantum dots}}.
\newblock \emph{\bibinfo{journal}{Appl. Phys. Lett.}}
...
\bibitem{Dial2013S}
\bibinfo{author}{Dial, O.~E.} \emph{et~al.}
\newblock \bibinfo{title}{Charge noise spectroscopy using coherent exchange oscillations in a singlet-triplet qubit}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}} \textbf{\bibinfo{volume}{110}},
  \bibinfo{pages}{146804} (\bibinfo{year}{2013}).
  
\bibitem{Harvey-Collard2015S}
\bibinfo{author}{Harvey-Collard, P.} \emph{et~al.}
\newblock \bibinfo{title}{Coherent coupling between a quantum dot and a donor in silicon}.
\newblock \bibinfo{journal}{Preprint at}
\url{http://arxiv.org/abs/1512.01606}
  (\bibinfo{year}{2015}).

\bibitem{Dehollain2013S}
\bibinfo{author}{Dehollain, J.~P.}, \bibinfo{author}{Pla, J.~J.}, \bibinfo{author}{Siew, E.}, 
\bibinfo{author}{Tan, K.~Y.}, \bibinfo{author}{Dzurak, A.~S.} \& \bibinfo{author}{Morello, A.}
\newblock \bibinfo{title}{Nanoscale broadband transmission lines for spin qubit control}.
\newblock \emph{\bibinfo{journal}{Nanotechnology}}
\textbf{\bibinfo{volume}{24}},
  \bibinfo{pages}{015202} (\bibinfo{year}{2013}).
...
\bibitem{Bylander2011S}
\bibinfo{author}{Bylander, J.} \emph{et~al.}
\newblock \bibinfo{title}{Noise spectroscopy through dynamical decoupling with a superconducting flux qubit}.
\newblock \emph{\bibinfo{journal}{Nature Phys.}} \textbf{\bibinfo{volume}{7}},
  \bibinfo{pages}{565--570} (\bibinfo{year}{2011}).

\bibitem{Laucht2016S}
\bibinfo{author}{Laucht, A.} \emph{et~al.}
\newblock \bibinfo{title}{A dressed spin qubit in silicon}.
\newblock \emph{\bibinfo{journal}{Nature Nanotechnol.}} \textbf{\bibinfo{volume}{12}},
  \bibinfo{pages}{61--66} (\bibinfo{year}{2017}).

\bibitem{Yan2013S}
\bibinfo{author}{Yan, F.} \emph{et~al.}
\newblock \bibinfo{title}{Rotating-frame relaxation as a noise spectrum analyser of a superconducting qubit undergoing driven evolution}.
\newblock \emph{\bibinfo{journal}{Nature Commun.}} \textbf{\bibinfo{volume}{4}},
  \bibinfo{pages}{2337} (\bibinfo{year}{2011}).

\bibitem{Astafiev2004S}
\bibinfo{author}{Astafiev, O.} \emph{et~al.}
\newblock \bibinfo{title}{Quantum noise in the Josephson charge qubit}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}} \textbf{\bibinfo{volume}{93}},
\bibinfo{pages}{267007} (\bibinfo{year}{2004}).

\bibitem{Shnirman2005S}
\bibinfo{author}{Shnirman, A.} \emph{et~al.}
\newblock \bibinfo{title}{Low- and high-frequency noise from coherent two-Level systems}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. Lett.}} \textbf{\bibinfo{volume}{94}},
\bibinfo{pages}{127002} (\bibinfo{year}{2005}).

\bibitem{Poudel2013S}
\bibinfo{author}{Poudel, A.}, \bibinfo{author}{Langsjoen, L.~S.}, \bibinfo{author}{Vavilov, M.~G.} \& \bibinfo{author}{Joynt, R.}
\newblock \bibinfo{title}{Relaxation in quantum dots due to evanescent-wave Johnson noise}.
\newblock \emph{\bibinfo{journal}{Phys. Rev. B}} \textbf{\bibinfo{volume}{87}},
  \bibinfo{pages}{045301} (\bibinfo{year}{2013}).
