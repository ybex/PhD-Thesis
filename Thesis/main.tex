...
\thesistitle{Advancing Si:P donor qubits towards large scale quantum computing:
Long-distance coupling} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
